...
<div class="container mx-auto px-4 py-4"> 
  <h1 class="text-4xl font-bold text-gray-800 mb-1">Kategori</h1>
  <p class="text-xl mb-4">Welcome, Admin</p>

  <div class="flex justify-between items-center mb-4">
    <!-- Tombol Tambah Kategori -->
    <a href="/auth/tambahkategori_admin" class="inline-block bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700">
      Tambah Kategori
    </a>
  ...
  <div class="w-full bg-white shadow rounded-lg overflow-x-auto">
    <table class="w-full table-auto">
      ...
      <tr>
        <th class="px-4 py-2 text-center text-sm font-semibold text-gray-700">ID Kategori</th>
        <th class="px-4 py-2 text-center text-sm font-semibold text-gray-700">Kategori</th>
      ...
      <?php foreach ($kategori as $kategori): ?>
        <tr class="bg-gray-50 border-b">
          <td class="px-4 py-2 text-center text-sm text-gray-600"><?= $kategori['id_kategori'] ?></td>
          <td class="px-4 py-2 text-center text-sm text-gray-600"><?= $kategori['nama_kategori'] ?></td>
            <td class="px-4 py-2 text-center text-sm space-x-2">
              <!-- Edit -->
                  <a href="/auth/editkategori_admin/<?= $kategori['id_kategori'] ?>"
                  class="text-yellow-500 hover:text-yellow-600" title="Edit">
                  <i class="fas fa-edit text-lg"></i>
                </a>

          <!-- Delete -->
            <a href="/deletekategori/<?= $kategori['id_kategori'] ?>"

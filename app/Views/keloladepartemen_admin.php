...
<div class="container mx-auto px-4 py-4"> 
  <h1 class="text-4xl font-bold text-gray-800 mb-1">Departemen</h1>
  <p class="text-xl mb-4">Welcome, Admin</p>

  <div class="flex justify-between items-center mb-4">
    <!-- Tombol Tambah Kategori -->
    <a href="/auth/tambahdepartemen_admin" class="inline-block bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700">
      Tambah Departemen
    </a>
  ...
  <div class="w-full bg-white shadow rounded-lg overflow-x-auto">
    <table class="w-full table-auto">
      ...
      <tr>
        <th class="px-4 py-2 text-center text-sm font-semibold text-gray-700">ID Departemen</th>
      ...
      <?php foreach ($departemen as $departemen): ?>
        <tr class="bg-gray-50 border-b">
          <td class="px-4 py-2 text-center text-sm text-gray-600"><?= $departemen['id_departemen'] ?></td>
          <td class="px-4 py-2 text-center text-sm text-gray-600"><?= $departemen['departemen'] ?></td>
            <td class="px-4 py-2 text-center text-sm space-x-2">
              <!-- Edit -->
                  <a href="/auth/editdepartemen_admin/<?= $departemen['id_departemen'] ?>"
                  class="text-yellow-500 hover:text-yellow-600" title="Edit">
                  <i class="fas fa-edit text-lg"></i>
                </a>

          <!-- Delete -->
            <a href="/deletedepartemen/<?= $departemen['id_departemen'] ?>"
